        ...
        <div class="row">
            <div id="enlacesContacto" class="mt-3 col-lg-6">
                <div class="my-2 content">
                    <h3 class="text-center pt-lg-4" tabindex="0">Encuéntranos en Redes Sociales</h3>
                    <div class="py-3 d-flex justify-content-center">
                        <a class="text-decoration-none enlaces" tabindex="0" href="https://www.tiktok.com/"
                            aria-label="Ir a Tiktok"><i class="mx-4 fa-brands fa-tiktok fa-3x"></i>@rbdm_gcm_TT</a>
                    </div>
                    <div class="py-3 d-flex justify-content-center">
                        <a class="text-decoration-none enlaces" tabindex="0" href="https://www.instagram.com/"
                            aria-label="Ir a Instagram">
                            <i class="mx-4 fa-brands fa-instagram fa-3x"></i>@rbdm_gcm_IG</a>
                    </div>
                    <div class="py-3 d-flex justify-content-center">
                        <a class="text-decoration-none enlaces" tabindex="0" href="https://x.com/"
                            aria-label="Ir a Twitter"><i class="mx-4 fa-brands fa-x-twitter fa-3x"></i>@rbdm_gcm_X</a>
                    </div>
                    <div class="py-3 d-flex justify-content-center">
                        <a class="text-decoration-none enlaces" tabindex="0" href="https://www.facebook.com/"
                            aria-label="Ir a Facebook"><i class="mx-4 fa-brands fa-facebook fa-3x"></i>@rbdm_gcm_F</a>
                    </div>
                    <div class="py-3 d-flex justify-content-center">
                        <a class="text-decoration-none enlaces" tabindex="0" href="https://www.youtube.com/"
            ...
            <div id="formularioContacto" class="mt-3 col-lg-6">
                <div class="my-2 content">
                    <h3 class="text-center pt-lg-4" tabindex="0">¿Necesitas contacto más directo?</h3>
                    <h3 class="text-center pb-lg-3" tabindex="0">Mándanos un Email</h3>
            ...
            <div class="mb-2 col">
                <div class="my-3 content">
                    <h3 class="text-center pt-lg-4" tabindex="0">Miembros del equipo</h3>
