    ...
    <main class="container-fluid signup">
        <div class="row justify-content-center">
            <div class="col-lg-6 my-lg-4 content">
                <h1 class="mt-3 text-center">Registro</h1>
                <form action="signup.php" method="POST" enctype="multipart/form-data" class="px-3 px-lg-5">
                    <div class="mb-3 text-center">
                        <label class="form-label">Correo Electrónico:</label>
                        <input type="email" name="email" class="form-control" placeholder="ejemplo@ejemplo.com" value=""
                            required>
                    </div>
                    <div class="mb-3 text-center">
                    ...
                    <div class="mb-3 text-center">
                        ...
                        <span id="errorApellidos" class="noError">Los apellidos solo pueden estar compuestos por letras
                            y espacios (no se admiten acentos, tampoco ñ/ç/similares)</span>
                    </div>
                    <div class="mb-3 text-center">
                    ...
                    <div class="mb-3 text-center">
                        ...
                        <span id="errorPais" class="noError">El pais solo puede estar compuesto por letras y espacios
                    ...
                    <div class="mb-3 text-center">
                        ...
                        <input type="text" name="telf" class="form-control" placeholder="+34623451789 ó 623451789"
                            value="" required>
                    </div>
                    <div class="mb-3 text-center">
