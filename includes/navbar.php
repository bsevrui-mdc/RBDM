<header>
  <nav class="container-fluid navbar navbar-expand-lg bg-primary text-uppercase px-3" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="navbar-nav me-auto">
        ...
        <li class="d-lg-none nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="usuarioDropdown" data-bs-toggle="dropdown" aria-expanded="false">Usuario</a>
          <ul class="dropdown-menu bg-secondary dropdown-menu-end menuDropdown" aria-labelledby="usuarioDropdown">
    ...
    <!-- Navbar >=lg -->
    <div class="d-none d-lg-flex me-5 align-items-center ms-auto me-5 iconos">
