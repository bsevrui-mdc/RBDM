    ...
    <div class="row">
        ...
        <div class="col-lg-2 py-5 py-lg-0">
            <div class="row">
                ...
                <div class="col-3 col-lg-12 d-flex justify-content-center">
                    <img src="/assets/icons/netflix.svg" class="icon" alt="Netflix">
                </div>
                <div class="col-3 col-lg-12 d-flex justify-content-center">
                    <img src="/assets/icons/hbo.svg" class="icon" alt="Max/HBO">
                </div>
                <div class="col-3 col-lg-12 d-flex justify-content-center">
                    <img src="/assets/icons/disney.svg" class="icon" alt="Disney+">
                </div>
            </div>
        </div>
