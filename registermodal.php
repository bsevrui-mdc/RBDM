...
<div id="id01" class=" modal">
    ...
    <form class="modal-content" action="register.php" method="POST">
        <div class="container">
            ...
            <input type="hidden" name="imagen" value="<?php echo $_SESSION['user_image'] ?>">
            <hr>
            <div class='row-form'>
                <div class='column-form'>
                    <label for="email"><b>E-mail</b></label>
                    <input type="email" placeholder="Enter Email" name="email"
                        value="<?php echo $_SESSION['user_email_address']; ?>" readonly>
                ...
                <div class='column-form'>
                    ...
                    <input type="text" pattern="^[0][1-9][0-9]{3}$|^[1-4][0-9]{4}$|^[5][0-2][0-9]{3}$" maxlength="5"
                        placeholder="Enter six digit postal code" name="postalcode" required>
